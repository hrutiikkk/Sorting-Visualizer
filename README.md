...
[Download](https://github.com/hrutiikkk/Sorting-Visualizer.git)
...
Option 1.) You can run Sorting Visualizer directly from the release. Download the release and run the .exe application i.e., Sorting Visualizer.exe -> [Download](https://github.com/hrutiikkk/Sorting-Visualizer.git)
